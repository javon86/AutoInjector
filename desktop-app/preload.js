...
contextBridge.exposeInMainWorld("api", {
  ...
  downloadAllLogs: () => ipcRenderer.invoke("logs:download-all"),
  ...
  startManagedTask: (userRequest, mode) => ipcRenderer.invoke("manager:start-task", { userRequest, mode }),
  butlerChat: (message) => ipcRenderer.invoke("butler:chat", { message }),
